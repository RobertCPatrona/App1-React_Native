...
-> Run `npm install --global expo-cli` then navigate to the code dir and run `npm install` then to start the app `npm start` and scan the QR code with the Expo mobile app. The app is diplayed on your phone. <br />
