...
-> Run `npm install --global expo-cli` to install expo, then navigate to the code directory and run `npm install`. To start the app, `npm start` and scan the QR code with the Expo mobile app. The app will run on your phone. <br />
